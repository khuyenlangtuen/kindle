 ...
 * @property string $ung_dung
 * @property string $download
 * @property string $nha_san_xuat
 */
class LanguageValue extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('seo_description, description, short_description,ung_dung,download,nha_san_xuat, created_at, updated_at', 'safe'),
	...
	public function beforeSave() {
		if ( parent::beforeSave() ) {
			...
			//$this->ung_dung = str_replace("../", "/", $this->ung_dung);
			//$this->download = str_replace("../", "/", $this->download);
		}
