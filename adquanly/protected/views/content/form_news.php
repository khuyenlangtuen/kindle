                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header">
                        	...
                        	<div>
                        	<a href="<?php echo CController::CreateUrl('content/news')?>"><i class="fa fa-backward"></i>&nbsp;<?php echo t('back').': '.t('Tất cả bài viết') ?></a>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                            		 ...
                            		 <select name="item[status]" class="form-control">
                                        <option <?php echo (isset($info['status']) && $info['status']==1) ? 'selected' : ''?> value="1"><?php echo t('Đã đăng');?></option>
                                        <option <?php echo (isset($info['status']) && $info['status']==0) ? 'selected' : ''?> value="0"><?php echo t('Chưa đăng');?></option>
                                     </select>
                            	</div>
                            </div>
                            <div class="panel-heading">
