                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								...
								<div class="form-group">
                            		 <label><?php echo t('Mô tả trang');?></label>
                                ...
                                <div class="form-group">
                            		 <label><?php echo t('Nôi dung');?></label>
                                ...
                                <div class="form-group">
                            		 <label><?php echo t('Tầm nhìn');?></label>
                                     <textarea class="form-control" rows="9" name="lang[ung_dung]"><?php echo isset($info->language->ung_dung) ? $info->language->ung_dung : ''?></textarea>
                                </div>
                                <div class="form-group">
                            		 <label><?php echo t('Sứ mệnh');?></label>
                                     <textarea class="form-control" rows="9" name="lang[download]"><?php echo isset($info->language->download) ? $info->language->download : ''?></textarea>
                                </div>
                                <div class="form-group">
                            		 <label><?php echo t('Giá trị cốt lỏi');?></label>
                                     <textarea class="form-control" rows="9" name="lang[nha_san_xuat]"><?php echo isset($info->language->nha_san_xuat) ? $info->language->nha_san_xuat : ''?></textarea>
                                </div>
