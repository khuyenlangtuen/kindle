                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="page-header">
                            ...
                            <?php
							   $this->renderPartial('//blocks/lang',array('url'=>CController::CreateUrl('banners/partner'),'lang'=>$lang));
							?>
                            </div>
                        	<div><a href="<?php echo CController::CreateUrl('banners/formaddpart')?>"  class="btn btn-default"><?php echo t('Thêm mới đối tác') ?></a></div>
                        </div>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                                        ...
                                        if($list)
                                        {
                                            foreach( $list as $key=>$value)
                                            {
                                            	...
                                            	<tr class="<?php echo $c;?> gradeA">
                                                    ...
                                                    <td><a href="<?php echo CController::CreateUrl('banners/formupdatepart',array('id'=>$value['id']))?>"><?php echo $value->language->name;?></a></td>
                                                    ...
                                                    <td class="center">
                                                    	...
                                                    	<a title="cập nhật" href="<?php echo CController::CreateUrl('banners/formupdatepart',array('id'=>$value['id']))?>" data-toggle="modal" class="btn btn-success btn-circle"><i class="fa fa-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            	<?php
