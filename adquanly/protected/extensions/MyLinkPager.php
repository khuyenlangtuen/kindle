        ...
        protected function createPageButtons()
        {
               ...
               // if($currentPage <=1)
                ...
                if(($page=$currentPage-1)<0)
                        $page=0;
                if($currentPage >= 1)      
                  $buttons[]=$this->createPageButton('Previous',$page,self::CSS_PREVIOUS_PAGE,$currentPage<=0,false);
                ...
                if($currentPage < $pageCount-1)
                  $buttons[]=$this->createPageButton('Next',$page,self::CSS_NEXT_PAGE,$currentPage>=$pageCount-1,false);
