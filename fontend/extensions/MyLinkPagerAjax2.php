...
class MyLinkPagerAjax2 extends CLinkPager
{
  ...
  /**
        ...
        {
                return new MyPaginationAjax2;
        }
        protected function createPageButton($label,$page,$class,$hidden,$selected)
    	{
    		if($hidden || $selected)
    			$class.=' '.($hidden ? self::CSS_HIDDEN_PAGE : self::CSS_SELECTED_PAGE);
    		return '<span id="sktrang_'.$page.'" class="'.$class.'">'.CHtml::link($label,$this->createPageUrl($page)).'</span>';
    	}
}
