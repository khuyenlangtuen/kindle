...
Yii::import('common.extensions.image.CImage_Driver');
...
class CImage {
	...
	public function __construct($image, $config = NULL)
	{
		...
		if ( ! is_file($image)) {
			// set default image
			$image = Yii::getPathOfAlias('upload') . '/thumbnail/no_image.gif';
        ...
        Yii::import("common.helpers.CArray");

		// Initialize the driver
		$this->driver = new $driver($this->config['params']);

		// Validate the driver
		if ( ! ($this->driver instanceof CImage_Driver))
